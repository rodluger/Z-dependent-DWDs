...
power_dat_F50 = pd.read_hdf('resolved_DWDs_{}.hdf'.format('F50'), key='total_power')
popt_F50 = pd.read_hdf('resolved_DWDs_{}.hdf'.format('F50'), key='conf_fit')
popt_F50 = popt_F50.values.flatten()

power_dat_FZ = pd.read_hdf('resolved_DWDs_{}.hdf'.format('FZ'), key='total_power')
popt_FZ = pd.read_hdf('resolved_DWDs_{}.hdf'.format('FZ'), key='conf_fit')
